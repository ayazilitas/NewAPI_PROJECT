...
public class yaleStepDefs {
    ...
    @When("User given the username as a {string} and password {string}")
    public void user_given_the_username_as_a_and_password(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new cucumber.api.PendingException();
    }
    ...
    @When("User should select the start time from <{int}:{int}> am")
    public void user_should_select_the_start_time_from_am(Integer int1, Integer int2) {
        // Write code here that turns the phrase above into concrete actions
        throw new cucumber.api.PendingException();
    }
    ...
    @When("User should selects the end time to <{int}:{int}> am")
    public void user_should_selects_the_end_time_to_am(Integer int1, Integer int2) {
        // Write code here that turns the phrase above into concrete actions
        throw new cucumber.api.PendingException();
    }
    ...
    @When("User should clicks the book button for Yale room")
    public void user_should_clicks_the_book_button_for_Yale_room() {
        // Write code here that turns the phrase above into concrete actions
        throw new cucumber.api.PendingException();
    }
